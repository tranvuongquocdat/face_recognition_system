...
class AttendanceCheckingWindowUI(object):
    def setupUi(self, MainWindow):
        ...
        self.lcdNumber.setGeometry(QtCore.QRect(scale_width(1230, width), scale_height(10, height), scale_width(241, width), scale_height(61, height)))
        font = QtGui.QFont()
        ...
        self.label.setGeometry(QtCore.QRect(scale_width(1550, width), scale_height(20, height), scale_width(250, width), scale_height(50, height)))
        font = QtGui.QFont()
